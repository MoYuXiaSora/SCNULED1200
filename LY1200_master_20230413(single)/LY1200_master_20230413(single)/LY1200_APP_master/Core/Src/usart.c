...
static volatile uint8_t USART3_DMA_Rx_Buffer[USART3_DMA_RX_BUFFER_LENGTH];
...
void MX_USART3_UART_Init(void)
{
  ...
  /* USER CODE BEGIN USART3_Init 2 */
	...
	HAL_UARTEx_ReceiveToIdle_DMA(&huart3,USART3_DMA_Rx_Buffer,sizeof(USART3_DMA_Rx_Buffer)/sizeof(USART3_DMA_Rx_Buffer[0]));
