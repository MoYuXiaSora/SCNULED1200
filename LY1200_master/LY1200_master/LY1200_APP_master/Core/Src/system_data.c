...
static struct SYS_DATA sys_Parament={
    ...
    .cct_Parament={
      ...
      .warm_Percentage=0       //暖色温输出结果 0.0%-100.0%
		...
		.LE_Parament={
			.type=LT_MAX,							//灯效类型
			.brightness=0.0,					//灯效亮度 0.0%-100.0%
			.color_Temperature=4600,	//灯效色温 2700-6500
			.freq = 'R',							//灯效频率 1 - 10 R（自动）
			.le_State = SETTING,			//特效状态
			.le_Update_Flag=FLAG_TRUE,//是否有新参数更新
			.cold_Percentage=0.0,			//冷色温输出结果 0.0%-100.0%
			.warm_Percentage=0.0  		//暖色温输出结果 0.0%-100.0%
		},
    .driver_Parament={
